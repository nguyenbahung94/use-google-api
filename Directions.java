package com.example.nbhung.mymap.API;

import android.util.Log;

import com.example.nbhung.mymap.Model.MyRouter;
...
import com.example.nbhung.mymap.View.RetrofitMap;
...
public class Directions {
    ...
    public void createRitrofit() {
        String or1 = String.valueOf(mOrigin.latitude);
        String or2 = String.valueOf(mOrigin.longitude);
        String ed1 = String.valueOf(mDestination.latitude);
        String ed2 = String.valueOf(mDestination.longitude);
