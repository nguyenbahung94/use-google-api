...
import com.example.admin.maplocation.Model.MyRouter;
...
//                    Log.e("thanh cong", String.valueOf(response.isSuccessful()));
                   String strpolyline = myRouter.getStrpolyline().getPoints();
                    List<leg> listleg = myRouter.getLegs();
                    for (leg ss : listleg) {
                        Log.e("listLeg", ss.getStartAdd());
                    }
                    Log.e("size", "polyline"+strpolyline);
